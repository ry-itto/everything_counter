...
extension UIViewController: UIViewControllerTransitioningDelegate {
    ...
    func presentSemiModal(_ viewController: UIViewController,
                          animated: Bool,
                          completion: (() -> Void)?) {
    ...
    public func presentationController(forPresented presented: UIViewController,
        ...
        let semiModalPresentationController = SemiModalPresentationController(presentedViewController: presented,
